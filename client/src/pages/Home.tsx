...
const mathSections: MathSection[] = [
  { id: "integrated-1", title: "Integrated Math 1", eyebrow: "FOUNDATIONS", activity: "Linear Launch", description: "Explore variables, proportional reasoning, and the first patterns of algebra.", note: "BUILD THE RULE", image: "/manus-storage/math-hub-addition_6d72e8f4.jpg", color: "orange" },
  { id: "algebra-1", title: "Algebra 1", eyebrow: "EQUATIONS & FUNCTIONS", activity: "Equation Studio", description: "Balance equations and use functions to describe a changing quantity.", note: "KEEP IT BALANCED", image: "/manus-storage/math-hub-multiplication_d7dba472.jpg", color: "blue" },
  { id: "pre-calculus", title: "Pre-Calculus", eyebrow: "FUNCTIONS & RATES", activity: "Function Fieldwork", description: "Trace patterns in functions, radians, and changing rates before calculus begins.", note: "NOTICE THE CHANGE", image: "/manus-storage/math-hub-patterns_2d2f52d2.jpg", color: "teal" },
  { id: "integrated-2", title: "Integrated Math 2", eyebrow: "QUADRATICS & SYSTEMS", activity: "Quadratic Workshop", description: "Compare parabolas, systems, and transformations one clear move at a time.", note: "FIND THE TURN", image: "/manus-storage/math-hub-patterns_2d2f52d2.jpg", color: "teal" },
  { id: "geometry", title: "Geometry", eyebrow: "SHAPE & PROOF", activity: "Shape Reasoning", description: "Use angle facts, similarity, and area to defend a geometric claim.", note: "MARK THE FACTS", image: "/manus-storage/math-hub-addition_6d72e8f4.jpg", color: "orange" },
  { id: "calculus", title: "Calculus", eyebrow: "CHANGE & ACCUMULATION", activity: "Rate of Change", description: "Connect slopes, derivatives, and accumulation through short visual prompts.", note: "FOLLOW THE RATE", image: "/manus-storage/math-hub-multiplication_d7dba472.jpg", color: "blue" },
  { id: "integrated-3", title: "Integrated Math 3", eyebrow: "MODELING & DATA", activity: "Model Builder", description: "Use exponentials, polynomials, and data to test a mathematical model.", note: "TEST THE MODEL", image: "/manus-storage/math-hub-patterns_2d2f52d2.jpg", color: "teal" },
  { id: "trigonometry", title: "Trigonometry", eyebrow: "ANGLES & CYCLES", activity: "Triangle Navigator", description: "Follow the relationships between sides, angles, and periodic patterns.", note: "TRACK THE CYCLE", image: "/manus-storage/math-hub-addition_6d72e8f4.jpg", color: "orange" },
  { id: "grade-4", title: "4th Grade Math", eyebrow: "NUMBER SENSE", activity: "Multiply & Measure", description: "Use place value, multiplication, and fractions to make strong number sense.", note: "MAKE A MODEL", image: "/manus-storage/math-hub-multiplication_d7dba472.jpg", color: "blue" },
];
